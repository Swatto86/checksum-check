    ...
    <div className="min-h-screen p-8">
      <div className="max-w-3xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-4xl font-bold text-center flex-grow bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent">
            # Checksum Check
          </h1>
            ...
            <div className="card bg-base-200 p-4">
              ...
              <div className="space-y-2">
                ...
                {hashResults && (
                  <>
                    <p className="text-sm">
                      Size: {formatFileSize(hashResults.file_size)}
                    </p>
                    <p className="text-sm">
                      Modified: {formatDate(hashResults.modified)}
                    </p>
                    <p className="text-sm">
                      Created: {formatDate(hashResults.created)}
                    </p>
                  </>
                )}
              </div>
              ...
              <div className="card bg-base-200 p-4">
                ...
                <div className="space-y-4">
                  {Object.entries(hashResults)
                    .filter(([algo]) =>
                      ["md5", "sha1", "sha256", "sha512"].includes(algo),
                    )
                    .map(([algo, hash]) => (
                      <div key={algo} className="space-y-1">
                        ...
                        <p className="text-sm break-all font-mono bg-base-300 p-2 rounded">
                          {hash}
                        </p>
                      </div>
                    ))}
